...
export default function Trailers({ apiBaseUrl }) {
  ...
  const handleSubmit = (trailerId) => {
    ...
    axios
      .put(`${apiBaseUrl}/trailers/${trailerId}`, updatedTrailer)
      .then((res) => {
  ...
  const deleteTrailer = (trailerId) => {
    ...
    swal("Are you sure you want to do this?", {
      ...
      .then((willDelete) => {
        if (willDelete) {
    axios.delete(`${apiBaseUrl}/trailers/${trailerId}`)
    .then((res) => {
              window.location.reload()
            ...
            >
              ...
              <div className="modal-form-column-two">
                ...
                <div className="trailer-update-button-container">
                  <button
                    className="trailer-update-button submit-button"
                    type="submit"
                  >
                    Submit
                  </button>
                ...
                <tr className="table-row-wrapper" {...row.getRowProps()}>
                  ...
                  <td className="table-action-icons-wrapper">
                    ...
                    <BsFillTrashFill
                      ...
                      onClick={() => {
                        deleteTrailer(row.original._id);
                      }}
                    />
                  </td>
                </tr>
